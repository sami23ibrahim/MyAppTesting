...
dependencies {
    ...
    implementation ("androidx.lifecycle:lifecycle-livedata-ktx:2.3.1" )// Use the latest version
    implementation ("androidx.compose.runtime:runtime-livedata:1.0.0" )// Use the latest version
